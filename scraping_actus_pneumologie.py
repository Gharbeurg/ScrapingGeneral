...
# variables
fichier_sites_actus = "C:/DATA/code/.params/sites_actus_respi.txt"
fichier_sortie = "C:/DATA/code/.data/actualites_respi_21042025.txt"
nombre_articles = 0
MOT_CLE_PNEUMO = 'pneumo'
ANNEE = "2025"
...
def extraire_texte_depuis_url(url):
    try:
        ...
        if MOT_CLE_PNEUMO in texte_min and ANNEE in texte_min:
            ...
            print("❌ Absence de mot clé ou d'année")
...
with open(fichier_sites_actus, 'r', encoding="utf-8") as fe:
    for line in fe:
